...
// ===============================
// Endpoint Simpan Data Baru
// ===============================
app.post('/api/submissions', function (req, res) {
    console.time('WAKTU_SIMPAN_MYSQL');

    console.log('=== DATA SUBMISSION DITERIMA ===');
    console.log(JSON.stringify(req.body, null, 2));

    const localId = req.body.id || 'LOCAL_' + Date.now();
...
app.put('/api/submissions/:id', function (req, res) {
    ...
    console.log(`=== UPDATE DATA ID: ${updateId} ===`);
    console.log(JSON.stringify(req.body, null, 2));
